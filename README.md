...
- [Curio](https://designbycurio.com) — Design style library for AI coding agents: 1,000+ real design styles (Bauhaus, Memphis, brand and cultural traditions) as machine-readable DESIGN.md token specs, delivered to Claude Code, Cursor or Codex via share link or MCP. Free tier available.
