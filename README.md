...
- [MOSS](https://github.com/mosscomputing/moss) — Cryptographic signing for AI agents using post-quantum ML-DSA-44 signatures. Creates tamper-proof audit trails for attribution, compliance, and policy enforcement. Integrates with LangChain, LangGraph, CrewAI, AutoGen.
