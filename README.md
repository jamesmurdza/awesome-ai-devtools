...
- [FutureOS](https://github.com/futuregene/future-os) — One AI agent everywhere: terminal UI, desktop, mobile, CLI, and IM bots from a single Rust gRPC backend. Built-in loop control plane for 24h+ runs with durable goals, event-sourced state, verification gates, and multi-agent orchestration.
