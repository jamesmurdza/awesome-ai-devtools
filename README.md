...
- [NarraNexus](https://github.com/NetMindAI-Open/NarraNexus) — Open-source AI agent team workspace by NetMind.AI. A ready-to-run team of agents that remember, collaborate, and use tools from day one, with multi-agent collaboration, composable capabilities (Memory, Awareness, Chat, RAG, Jobs, Skills, Social Network, Matrix), and Matrix-based communication. Cloud, macOS, and local deployment options available.
