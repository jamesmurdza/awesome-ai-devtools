...
- [Remogram](https://github.com/attebury/remogram) — Open-source SCM/forge boundary CLI and MCP server for AI coding agents. Normalizes GitHub, GitLab, and Gitea repository, ref, pull request, checks, merge, and sync facts into typed JSON packets, with opt-in forge writes for controlled PR, issue, and status operations. MIT.
