...
- [UIZZE](https://github.com/uizze/uizze) — Anti-UI-slop Skill and conservative GitHub Action for coding agents: grounds UI work in 800,000+ real web and iOS screens, enforces product-specific context and complete states, and runs a finish gate before shipping. Optional authenticated MCP tools: find_ui_references and find_ui_materials at https://uizze.com/mcp.
