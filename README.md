...
- [context-os](https://github.com/sravan27/context-os) — Claude Code/Codex context optimizer that builds a local repo graph, injects ranked `file:line` candidates, and ships a GitHub Action leak gate for agent-cost checks. No embeddings, servers, or telemetry.
