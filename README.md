...
- [judgekit](https://github.com/alvabillwu/judgekit) — LLM-as-judge harness with pluggable judges, rubric-based evaluation, calibration, and multi-judge ensembling.
