...
- [Cate](https://github.com/0-AI-UG/cate) - Open-source infinite-canvas desktop IDE where editors, terminals, browsers, docs, and AI agents float as draggable nodes on a zoomable canvas. Run and monitor multiple Claude Code agents in parallel, each as its own panel on one spatial workspace. Electron, MIT, macOS/Windows/Linux.
