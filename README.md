...
- [Data Olympus](https://github.com/knaisoma/data-olympus) - Local-first governed project knowledge for AI coding agents. Exposes an MCP server where agents can consult accepted rules and propose new learnings, while validity windows, supersession links, and human promotion keep stale or unreviewed context out of future prompts.
