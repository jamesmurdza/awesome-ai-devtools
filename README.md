...
- [Codecast](https://codecast.sh) — Team dashboard and memory for coding agent sessions. A daemon syncs Claude Code, Codex, Cursor, and Gemini sessions from the machines where they run; teams watch and steer them from web, desktop, or phone, search every past session, and trace a line of code back to the conversation that wrote it. MIT licensed.
