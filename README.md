...
- [Tintpad](https://github.com/sorkila/tintpad) — Native macOS menu-bar launcher: one hotkey opens your terminal at the right repo with Claude Code, Codex, or any agent already running. Frecency repo search, run modes (Safe/Default/YOLO), git worktrees, headless dispatch. Local-only, free, open source (MIT).
