...
- [Env-Doctor](https://github.com/mitulgarg/env-doctor) - CLI diagnostics for GPU/CUDA compatibility issues on ML environments: detects driver/toolkit/PyTorch mismatches, compute capability failures (e.g. Blackwell sm_120), generates safe pip installs, model VRAM checks, Docker/CI-CD validation and more! pip install env-doctor
