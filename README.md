...
- [Shadcn Dashboard MCP](https://shadcndashboard.dev/mcp) — Connect your AI development tools to the Shadcn Dashboard registry for seamless, AI-ready MCP integration.
