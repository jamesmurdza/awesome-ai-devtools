...
- [Agent Teams AI](https://github.com/777genius/agent-teams-ai) — Open-source orchestration platform for autonomous coding-agent teams across Claude Code, Codex, OpenCode, Cursor, Grok, GitHub Copilot, Kiro, and other providers, with inter-agent messaging, Kanban task management, peer code review, and multi-team workflows.
