...
- [n-skills](https://github.com/numman-ali/n-skills) — Curated plugin marketplace for AI agents. Works with Claude Code, Codex, Cursor, Windsurf, Cline, OpenCode, and anything that reads AGENTS.md. 992 stars, Apache-2.0.
