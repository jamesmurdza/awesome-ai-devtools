...
- [Dakera](https://github.com/Dakera-AI/dakera-docs) — Self-hosted agent memory server providing persistent cross-session memory for AI coding agents. Hybrid BM25 + HNSW vector retrieval, decay-weighted recall, multi-agent namespacing, and MCP integration. Works with Claude Code, Cursor, Windsurf, and any MCP client. SDKs for Python, TypeScript, Go, and Rust.
