...
- [Firekeep](https://github.com/kapella-hub/FirekeepHQ) — Self-hosted context, memory, coordination, and evidence shared across Claude Code, Codex, Kiro CLI, OpenCode, and other MCP clients.
