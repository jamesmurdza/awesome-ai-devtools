...
- [Superagent](https://github.com/pungme/superagent-desktop) — macOS desktop app that gives Claude Code and Codex a real browser to navigate and drive, an iOS Simulator to install and screenshot apps in, and a phone companion app + relay for remote monitoring. Free, open-source (MIT).
