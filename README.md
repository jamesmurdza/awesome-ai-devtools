...
- [HarnessRouter](https://harnessrouter.ai) — Hosted unified API for running coding agent harnesses (Codex, Claude Code, Hermes) behind your product. One contract for tasks, sandboxed sessions, streaming, files, and reviewable artifacts. Free to build on; credits are consumed only when tasks run.
