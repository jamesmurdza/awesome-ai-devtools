...
- [GenTech Agent Kit](https://github.com/ProtoJay4789/gentech-agent-kit) — On-chain agent identity (ERC-8004) and x402 payment infrastructure for multi-agent systems. Agents register, discover, and pay each other via USDC on Base, Solana, and Avalanche. Includes MCP server for blockchain data and AI-powered wallet analytics.
