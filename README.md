...
- [claude-skills](https://github.com/AlirezaRezvani/claude-skills) — Comprehensive library of 337+ Claude Code skills and agent plugins. Covers engineering, DevOps, marketing, product, compliance, C-level advisory, and academic research. Works with Claude Code, Codex, Gemini CLI, Cursor, and 9 more coding agents. 5,200+ stars, MIT.
