...
- [Aura IDE](https://github.com/CarpseDeam/Aura-IDE) — Open-source desktop AI coding harness with Planner/Worker separation, reviewable diffs, validation, and run receipts.
