...
- [Awesome AI Tokenomics](https://github.com/QuesmaOrg/awesome-ai-tokenomics) — Curated list of tools, benchmarks, papers, and copy-paste configs for AI token costs: what tokens cost, where they get wasted, and how to cut the bill.
