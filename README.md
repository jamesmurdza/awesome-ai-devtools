...
- [openai/skills](https://github.com/openai/skills) — Official OpenAI skills catalog for Codex. Curated and experimental skills for common development workflows including code review, debugging, documentation, and security. 23k+ stars, now superseded by openai/plugins but remains the canonical skills reference.
- [agent-skills](https://github.com/addyosmani/agent-skills) — Production-grade engineering skills for AI coding agents. 24 lifecycle skills with verification gates and anti-rationalization tables. Works with Claude Code, Cursor, Antigravity, Copilot, Kiro IDE, and more. 67k+ stars.
