...
- [ctxpack](https://github.com/alvabillwu/ctxpack) — Pack documents into an LLM context-window budget with 3 strategies (priority, ratio, balanced), utilization tracking, and model presets.
