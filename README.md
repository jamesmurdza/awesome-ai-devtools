...
- [Claudescope](https://github.com/vladar107/claudescope) — Local-first CLI that serves a web UI to browse, search, and analyze AI coding-agent transcripts across Claude Code, Codex, Junie, pi, opencode, and Copilot CLI. Sessions merged by working directory, with DuckDB full-text search and token-cost analytics.
