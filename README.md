...
- [Unified AI System](https://github.com/happy520ai/unified-ai-system) — Open-source, terminal-first control plane for Codex and MCP workflows, with model-routing foundations, human approval gates, workforce orchestration, execution evidence, provider-free prompt enhancement, nine MCP tools, and a credential-free Docker demo.
