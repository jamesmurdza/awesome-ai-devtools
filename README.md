...
- [Haunt API](https://github.com/Darko893/mcp-server) — MCP server for extracting clean, structured data from any URL with Cloudflare bypass. Works directly from Claude, Cursor, or any MCP-compatible AI agent. Free tier available.
