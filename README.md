...
- [SandBase CLI](https://github.com/sandbaseai/cli) — Agent-first MCP onboarding CLI that detects and safely configures 25 coding clients, including Claude Code, Codex, Cursor, Windsurf, Gemini CLI, and OpenCode. Connects them to 2,000+ tools and 200+ AI models with structured JSON output, ownership protection, and automatic rollback. Apache-2.0.
