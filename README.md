...
- [Releasepress](https://github.com/attebury/releasepress) — Open-source CLI for build- and package-neutral release hygiene, public tree exporting, and staging for AI coding agents. Builds clean public trees from allowlists, scans for private/local material, packages surfaces, and gates public provider deliveries behind human-reviewed target attestations. MIT.
