...
- [Claim Plane](https://github.com/SkeinRank/claim-plane) — Open-source authority and evidence control plane for AI coding agents. Integrates with Codex CLI to turn proposed task scope into bounded mutation authority, block undeclared writes before mutation, record controlled amendments, and independently verify final delivery.
