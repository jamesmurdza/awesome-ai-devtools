...
- [agent-skills-hub](https://github.com/agent-skills-hub/agent-skills-hub) — Global registry of 790+ agent skills for Claude Code, Gemini, Cursor, Kiro, Codex, Antigravity, OpenCode, and more. NPX-based CLI installer, search and filter by category, free and open source.
