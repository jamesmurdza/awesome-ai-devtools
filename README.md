...
- [hcom](https://github.com/aannoo/hcom) — CLI that hooks Claude Code, Antigravity, Codex, OpenCode, Kilo, and Cursor into a shared messaging bus so agents can message, observe, and spawn each other across terminals. Single Rust binary, SQLite-backed, no background service. MIT.
