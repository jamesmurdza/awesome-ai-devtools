...
- [Better Agent](https://github.com/ofekron/better-agent) — Local web workspace for running and supervising native Claude, Codex, and Gemini coding-agent sessions with parallel delegation, persistent state, approval gates, file access, and restart recovery.
