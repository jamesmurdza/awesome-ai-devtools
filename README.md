...
- [AI Badger](https://github.com/PVRLabs/aibadger) — Lightweight local-first CLI that intelligently extracts clean, relevant codebase context and prepares it for manual pasting into any AI chat (Claude, ChatGPT, Grok, DeepSeek, etc.).
