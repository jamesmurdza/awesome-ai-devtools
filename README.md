...
- [agent-qa](https://github.com/vostride/agent-qa) — Self-improving QA agent for writing and running natural-language web and mobile tests, with run memory, UI-change adaptation, and regression detection.
