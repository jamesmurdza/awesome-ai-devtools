...
- [CompozyOS](https://github.com/compozy/compozy) — Open-source operating system for AI agents: one system instead of the dozen tools people glue together. Plug in the agent CLIs you already use (26 providers) and they run as a team on loops and schedules, sharing one project memory, under permissions and approvals, supervised from a web shell.
