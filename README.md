...
- [ADHDev](https://github.com/vilmire/adhdev) — Self-hosted control plane for CLI coding agents (Claude Code, Codex, Cursor, Antigravity) with a web dashboard, mobile push approvals, queued task dispatch into isolated git worktrees across machines, and ff-only auto-merge of validated work. P2P WebRTC, no port forwarding.
