...
- [Statewave](https://github.com/caura-ai/statewave) — Open-source MCP server for shared state across AI agents. Synchronizes context and enables persistent coordination between multi-agent workflows. 
...
- [MemClaw](https://github.com/caura-ai/memclaw) — Open-source persistent memory engine for AI coding agents. Stores, retrieves, and shares long-term context across coding sessions and agent workflows. Supports MCP and works with Claude Code, Codex, Cursor, Windsurf, and other AI tools.
