...
- [UIZZE](https://github.com/uizze/uizze) — Anti-UI-slop skill and hosted MCP for coding agents: grounds UI work in 800,000+ real web and iOS screens, enforces product-specific context and complete states, and runs a finish gate before shipping. Free preview: https://uizze.com/mcp/preview.
