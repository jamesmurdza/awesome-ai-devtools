...
- [octomux](https://github.com/ShreyPaharia/octomux) — Local dashboard for orchestrating parallel Claude Code and Cursor agents, each in its own git worktree, with a unified permission inbox, a live monitor grid of all running agents, and in-app diff review with human-gated PR publishing. Local-first, MIT.
