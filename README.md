...
- [Okto Pulse](https://github.com/OktoLabsAI/okto-pulse) — Local-first, spec-driven SDLC workbench for AI coding agents over MCP. Turns ideas into governed specs, sprints, and tasks with 17 enforced gates covering reviewer separation, spec coverage, and test evidence — no card reaches "done" on a claim alone.
