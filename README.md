...
- [Context OS](https://github.com/sravan27/context-os) — Claude Code token optimization layer. One curl command installs response shaping, noise filtering, thinking budget cap, Haiku subagent for exploration, output compression hooks, and session memory. 32% token reduction measured, zero dependencies, reversible, MIT.
