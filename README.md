...
- [Claudexor](https://github.com/razzant/claudexor) — Local-first control plane for routing coding work across Claude Code, Codex, Cursor, and OpenCode. Tracks quota and rotates across multiple Claude Code and Codex subscriptions, preserves bounded task context, and supports Best-of-N and cross-model review.
