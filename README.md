...
- [faf-cli](https://github.com/Wolfe-Jam/faf-cli) — Foundational AI-context format. Authors persistent project DNA (.faf files) that give any AI instant, structured context. IANA-registered (application/vnd.faf+yaml). Works with Claude, Gemini, Grok, Cursor, and Windsurf.
