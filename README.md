...
- [Agentlas OS](https://github.com/agentlas-ai/Agentlas-OS) — Apache-2.0 local-first Agent Operation Environment (AOE) for building or borrowing specialist agents, composing teams, and running them across Claude Code, Codex, Gemini CLI, Cursor, and local models with permission and verification gates.
