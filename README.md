...
- [PageGuard](https://pageguard.org) — AI-powered website health scanner that checks SEO, performance (Core Web Vitals), accessibility (WCAG 2.1), and best practices. Generates plain-English AI reports in ~30 seconds using Cloudflare Workers AI. No signup required.
