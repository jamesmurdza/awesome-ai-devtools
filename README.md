...
- [agenttrace](https://github.com/luoyuctl/agenttrace) — Local-first TUI observability for AI coding agent sessions. Tracks cost, tokens, tool failures, latency, anomalies, health scores, diffs, and CI gates across Claude Code, Codex CLI, Gemini CLI, Aider, Cursor exports, and more.
