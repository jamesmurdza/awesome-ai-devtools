...
## Observability
- [AgentWatch](https://github.com/nicofains1/agentwatch) - Multi-agent observability for cascade failure detection, fleet-wide heartbeat monitoring, and forensic replay across agent systems.
