...
- [Capacity](https://capacity.so) — AI-powered full-stack web app development that turns natural language prompts into fully functional web applications.
...
- [Frontly](https://fronty.com/) — Convert the uploaded image to HTML and CSS code.
...
- [Gru.ai](https://www.gru.ai/) — An AI developer can help you solve technical problems and tackle daily coding tasks, such as building algorithms, debugging issues, testing solutions, and answering programming questions, etc.
...
- [EntelligenceAI](https://entelligence.ai/pr) — AI-powered code reviews for GitHub and GitLab that improve over time based on user comments
...
- [Upstream Agents](https://upstreamagents.com/) — Run AI coding agents in isolated sandboxes connected to your GitHub repositories. Supports Claude Code, Codex, and OpenCode.
...
- [DiagramGPT](https://www.eraser.io/diagramgpt) — DiagramGPT is a free AI-based web app that converts a schema, an infrastructure definition, a code snippet, or a plain language description into diagrams. The tool can generate flowcharts, entity relationship diagrams, cloud architecture diagrams and sequence diagrams.
