...
- [Continuum](https://continuumcode.ai/) — Free workbench for running Claude Code, Codex, Cursor, and Grok agents in parallel isolated git worktrees. Includes plan and diff review, session handoff, and remote control from Mac, iPhone, and web.
