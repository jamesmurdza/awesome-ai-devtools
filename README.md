...
- [LocalGateway](https://github.com/Correctover/local-gateway) — Desktop LLM gateway CLI with zero-dependency multi-provider failover. Routes between OpenAI, Anthropic, DeepSeek, Groq and more with automatic model name mapping. Works with Cursor, Claude Desktop, and Windsurf.
