...
- [StackPicks](https://stackpicks.dev) — Curated open-source AI dev tools directory with hand-written curator takes on tradeoffs, "use this if / skip if" guidance, and MCP server subdirectory.
