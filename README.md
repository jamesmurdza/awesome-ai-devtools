...
- [SAGE](https://github.com/PsYcGoD/sage) — Local-first CLI and MCP wrapper for AI coding agents. Records command history locally and returns compressed terminal output to reduce context noise.
