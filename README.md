...
- [Garcon](https://github.com/cfal/garcon) — Self-hosted browser and mobile workspace for running, steering, and reviewing parallel Claude Code, Codex, Cursor Agent, OpenCode, Amp, Droid, and Pi sessions, with integrated terminal, files, Git/PR workflows, approvals, scheduling, and cross-agent transfers.
