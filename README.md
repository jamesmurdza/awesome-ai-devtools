...
- [lean-ctx](https://leanctx.com) — Open-source context runtime for AI coding agents. MCP server and shell hook that reduces token costs by 60–99%. 46 tools, session caching, AST-aware compression (18 languages), 90+ shell patterns. Single Rust binary. [Source](https://github.com/yvgude/lean-ctx). Apache-2.0.
