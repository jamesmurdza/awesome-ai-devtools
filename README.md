...
- [Hype Stack MCP](https://github.com/BetterTyped/hype-stack) — Local MCP server (~11 tools) that lets AI agents search, plan, and install production fullstack feature packs into a Hype Stack monorepo. One-command setup: `npx @hype-stack/cli mcp install`. [Docs](https://www.hype-stack.dev/mcp)
