...
- [TWZRD Agent Intel](https://intel.twzrd.xyz) — Agent wallet trust scoring for multi-agent DevTools pipelines. Verify AI agent identity before granting access to paid APIs or logging agent activity. Free MCP: `{"mcpServers":{"twzrd-agent-intel":{"url":"https://intel.twzrd.xyz/mcp"}}}`
