...
- [doraval](https://github.com/saif-shines/doraval) — Open-source CLI that scans, reviews, and fixes agent context (skills, rules, CLAUDE.md, AGENTS.md) across Claude, Cursor, Codex, Copilot, and Grok.
