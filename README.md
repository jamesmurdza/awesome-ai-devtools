...
- [Zambo](https://zambo.dev/) — Open-source MCP server that gives any coding agent 120 execution tools (code audit, lead gen, price tracking, payments, prompt defense) through one zero-auth endpoint. Works across Claude Code, Cursor, Windsurf, and Cline. Free 20 calls/tool/day, no account.
