...
- [AgentVoy](https://github.com/agentvoy/agentvoy) — Universal AI agent platform that scaffolds, configures, guards, and deploys AI agents across 7 frameworks (OpenAI Agents SDK, Anthropic, CrewAI, LangGraph, Google ADK, LlamaIndex, AutoGen). Built-in guardrails (rate limiting, topic blocking, PII filtering), real-time DevTools dashboard, multi-agent sequential pipelines, and one-command deployment to Docker/Fly.io/Railway/GCP/AWS. ([Website](https://agentvoy.com))
