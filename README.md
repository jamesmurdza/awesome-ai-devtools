...
- [InsForge CLI](https://github.com/InsForge/CLI) — CLI for [InsForge](https://insforge.dev/), a backend built for agentic development providing auth, databases, file storage, serverless functions, real-time and AI gateway.
