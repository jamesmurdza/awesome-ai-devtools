...
- [Open Index](https://github.com/DrDroidLab/open-index) — Open-source context layer for domain-specialized AI agents that builds searchable structured knowledge graphs with hybrid semantic search and exposes validated read/write access over MCP.
