...
- [Unified AI System](https://github.com/happy520ai/unified-ai-system) — Open-source, terminal-first control plane for Codex and MCP workflows, with model routing, human approval gates, workforce orchestration, execution evidence, an 8-tool MCP server, and a credential-free Docker demo.
