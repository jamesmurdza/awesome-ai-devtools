...
- [UIZZE](https://uizze.com/) — Anti-slop UI reference platform with a free-to-browse public Web and iOS catalog plus full-access MCP workflows for AI coding agents: reference packs, design contracts, implementation validation, audits, and critiques.
