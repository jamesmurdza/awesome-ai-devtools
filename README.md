...
- [AQ](https://aq.dev/) — Multiplayer coding harness that runs Claude Code, Codex, and other CLI agents in parallel isolated git worktrees on your team's own VM. Teammates open the same live terminal sessions, previews, and reviews from the browser, and sessions survive laptop close.
