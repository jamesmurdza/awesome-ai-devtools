...
- [SandBase CLI](https://github.com/sandbaseai/cli) — Open-source CLI/MCP bridge for routing requests across 2,000+ AI models and APIs. Supports 25 AI clients, six MCP tools, OAuth, and rollback, with a pinned v0.1.17 release install path.
