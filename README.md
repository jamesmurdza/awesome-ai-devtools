...
- [AIWorkHub](https://github.com/shrec/AIWorkHub) — Open-source, repository-native control plane for Codex, Claude, Copilot, DeepSeek, and GLM coding agents, with dependency-aware task DAGs, isolated workers, durable context, source intelligence, and evidence-based review.
