...
- [SpecLock](https://github.com/sgroy10/speclock) — AI Constraint Engine that enforces CLAUDE.md, .cursorrules, and AGENTS.md rules as laws. Semantic conflict detection catches euphemisms, temporal evasion, and hidden violations that keyword matching misses. 51 MCP tools, 991 tests, MIT licensed. Works with Claude Code, Cursor, Windsurf, Copilot, Gemini, Aider, Cline.
