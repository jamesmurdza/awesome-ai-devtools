...
- [Shadcn Dashboard MCP](https://shadcndashboard.dev/mcp) — Connect your AI development tools to the Shadcn Dashboard registry to streamline your workflow. With AI-ready Shadcn Dashboard MCP integration.
