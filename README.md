...
- [Harness Starter Kit](https://github.com/harnessworks/harness-starter-kit) — Prompt-first harness engineering kit for AI coding agents. Turns repeated agent mistakes into durable repository instructions, drift checks, decision and failure memory, adoption reports, and effectiveness measurement across common stacks.
