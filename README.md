...
- [5dive](https://github.com/5dive-ai/5dive) — Self-hosted platform for running a company of AI coding agents (Claude Code, Codex, Grok, and more) on your own server. One-command spin-up of named agents, cron + heartbeat scheduling, Telegram control, and a babysit + needs-you triage dashboard.
