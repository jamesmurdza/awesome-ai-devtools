...
- [ai-cost](https://github.com/dwylq/ai-cost) — CLI tool for checking AI model pricing across 113 models and 20 providers. Zero dependencies, works offline. `npx ai-cost gpt-4o --input 100k --output 50k`
- [ai-pricing](https://github.com/dwylq/ai-pricing-npm) — Offline-first JavaScript library with AI model pricing data. 113 models, 20 providers, zero network calls. `npm install ai-pricing`
