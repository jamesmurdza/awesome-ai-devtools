...
- [Orkas](https://github.com/Orkas-AI/Orkas) — Open-source local-first desktop workspace that runs Claude Code, Codex CLI, and built-in agents in parallel, coordinating work with shared files and approval controls. [Website](https://orkas.ai?source=gh-aidevtools)
