...
- [AI.MD](https://github.com/sstklen/ai-md) — Converts human-written CLAUDE.md into AI-native structured-label format using a 6-phase methodology. Reduces file size by 53% and line count by 37% while improving rule compliance from 6/8 to 8/8 across 4 LLM models. Installable as a Claude Code skill.
