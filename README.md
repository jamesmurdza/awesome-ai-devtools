...
- [skillkit](https://github.com/rohitg00/skillkit) — Package manager for AI agent skills. Install from 400K+ skills across 31 sources, auto-translate between formats, and ship to 46+ agents including Claude Code, Codex, Cursor, Gemini CLI, Copilot, Windsurf, and Aider. Apache-2.0.
