...
- [Agent Console](https://github.com/Perseon-Lab/agent-console) — Open-source browser mission control for Hermes-powered AI agents, with chat, sessions, cron jobs, skills, voice controls, and read-only mission runs in one local web UI.
