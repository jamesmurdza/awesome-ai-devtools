...
- [PinkCode](https://github.com/3xian/PinkCode) — Open-source desktop GUI for Grok Build that runs multiple coding-agent sessions in parallel and visualizes task activity, token and credit usage, file changes, and permissions over ACP.
