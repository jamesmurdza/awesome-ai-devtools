...
- [codex-profiles](https://github.com/Ducksss/codex-profiles) — Bash CLI wrapper for launching OpenAI Codex CLI/Desktop with named isolated `CODEX_HOME` profiles, keeping account auth, config, sessions, connectors, plugins, and logs separated across work contexts.
