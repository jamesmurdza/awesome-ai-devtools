...
- [AgentLens](https://github.com/ModernOps888/agentlens) — Debugger and replay inspector for multi-agent LLM workflows. Captures and time-travels through every LLM call, tool invocation, and decision, with cost tracking and anomaly detection. MCP-native.
