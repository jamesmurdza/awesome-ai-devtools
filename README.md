...
- [Skillpress](https://github.com/attebury/skillpress) — Open-source CLI for syncing portable Agent Skills directories across Codex, Claude Code, Cursor, and other agent surfaces. Installs full skill directories, renders provider-specific layouts, records install manifests, and reports drift.
