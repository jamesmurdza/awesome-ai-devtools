...
- [Open Code Review](https://github.com/alibaba/open-code-review) — Free and open source code review tool combining deterministic pipelines with LLM Agent. Battle-tested at Alibaba's scale with built-in fine-tuned ruleset and precise line-level comments.
